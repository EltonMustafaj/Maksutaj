      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="lg:w-2/3 text-center lg:text-left mb-12 lg:mb-0">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-extrabold text-white leading-[1.1] mb-6 uppercase">
              UMFASSENDER <br />
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
              <a href="#kontakt" className="bg-brand-gold hover:bg-yellow-500 text-brand-brown px-8 py-4 font-display font-bold uppercase tracking-wide transition-all duration-300 shadow-xl inline-flex items-center justify-center group">
                Nehmen Sie Kontakt auf
                <svg className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
                </svg>
              </a>
              <a href="#services" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-brand-brown px-8 py-4 font-display font-bold uppercase tracking-wide transition-all duration-300 inline-flex items-center justify-center">
                Leistungsübersicht
              </a>
            </div>
          </div>
          ...
          <div className="lg:w-1/3 flex justify-center lg:justify-end">
            <div className="bg-brand-brown text-white p-8 sm:p-10 border-4 border-brand-gold max-w-sm text-center shadow-2xl relative">
              ...
              <h3 className="text-4xl sm:text-5xl font-display font-black text-brand-gold mb-2">-10%</h3>
